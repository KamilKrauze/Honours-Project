...
coeffs = pywt.dwt2(img_noise, 'db4')  # level - 1
cA1, (cH1, cV1, cD1) = coeffs

coeffs2 = pywt.dwt2(cA1, 'db4')  # level - 2
cA2, (cH2, cV2, cD2) = coeffs2

coeffs3 = pywt.dwt2(cA2, 'db4')  # level - 3
...
Y_cA2 = pywt.idwt2((cA3, (Y_cH3, Y_cV3, Y_cD3)), 'db4')
Y_cA1 = pywt.idwt2((cA2, (Y_cH2, Y_cV2, Y_cD2)), 'db4')
Y_cA = pywt.idwt2((cA1, (Y_cH1, Y_cV1, Y_cD1)), 'db4')
